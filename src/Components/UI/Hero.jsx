  ...
  return (
    <section className="py-28 min-h-screen">
      <div className="flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="border-[24px] border-gray-400 w-full lg:w-1/2 shadow-xl rounded-lg h-[350px] mt-10 lg:mt-0">
          <div className="-mt-5 w-full flex items-center justify-center">
            <div className="h-5 w-5 rounded-full bg-gray-100 border-[7px] border-gray-800"> </div>
          </div>
          <div className="w-full h-full bg-cover bg-center object-cover" style={{ backgroundImage: `url(${ProfileImg})` }}></div>
        </div>
      </div>
      <div className="mt-20">
        <h2 className="text-xl text-center mb-8 font-bold text-gray-700">Tech Stack</h2>
        <div className="scroll-container">
          <div className="scroll-content gap-10 md:gap-20 xl:gap-32">
